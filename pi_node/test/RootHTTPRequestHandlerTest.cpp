...
TEST_GROUP(RootHTTPRequestHandlerTest) {
    TEST_SETUP() {
        ...
        m_uut = new PiNode::RootHTTPRequestHandler();
    }
    ...
    PiNode::RootHTTPRequestHandler *m_uut;
};
...
TEST(RootHTTPRequestHandlerTest, postTest) {
    ...
    CHECK_EQUAL(m_response->m_response.str(), PiNode::RootHTTPRequestHandler::RESPONSE);
