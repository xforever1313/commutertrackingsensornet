...
const std::string ShutdownHTTPRequestHandler::POST_TRUE_MESSAGE = "Shutting down picture parser...";
const std::string ShutdownHTTPRequestHandler::POST_FALSE_MESSAGE = "Picture Parser will not shutdown.";
const std::string ShutdownHTTPRequestHandler::GET_MESSAGE = "Form data:\n\tshutdown=true\tShut down the picture parser";
